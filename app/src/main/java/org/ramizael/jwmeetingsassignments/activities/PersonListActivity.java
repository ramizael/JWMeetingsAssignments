            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(PersonDetailFragment.ARG_ITEM_ID, holder.mItem.getId().toString());
                        ...
                        intent.putExtra(PersonDetailFragment.ARG_ITEM_ID, holder.mItem.getId().toString());
